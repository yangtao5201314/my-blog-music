...
import blogAvatar from "@a/image/warbler1.jpeg";
...
<template>
  ...
  >
    <div class="flex flex-col justify-center items-center">
      <i class="iconfont icon-off-search change-color text-black" @click="toggleDisc"></i>
      <!-- 播放器列表 -->
  ...
  <div :class="['music-disc', getIsPaused ? 'music-left' : '']">
    ...
    <div class="info-box">
      <div class="info">
        ...
        <div class="text-sm whitespace-nowrap text-black">
          {{ getMusicDescription?.ar[0]?.name || "歌手走丢了" }}
        </div>
      </div>
      <i
        :class="['change-color', 'iconfont', getIsPaused ? 'icon-zanting text-black' : 'icon-bofangzhong ']"
        @click="playMusic"
      ></i>
    </div>
  </div>
